namespace marquee_backend.Regex
{
    public static class RegexPatterns
    {
        ...
        public const string RoleNameRegex = "^[a-zA-Z ]{5,30}$";
        public const string UsernameRegex = "^[a-z0-9]{4,20}$";
        public const string FullNameRegex = "^[a-zA-Z ]{2,50}$";
    }
}
